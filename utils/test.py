...
def evaluate(args):
    ...
    if "FR" in cfg.eval_type:
        ...
        if cfg.model_folder is not None:
            ...
            model_paths = [path for path in model_paths if "header" not in os.path.basename(path).lower()] # Filter out files that contain "header" in the name
    ...
    if "MAD" in cfg.eval_type:
        mad_eval(
            ...
            normalization_type=cfg.normalization_type, use_open_clip_model= cfg.use_open_clip_model, header_path=cfg.header_path,
