...
def get_model(name, **kwargs):
    ...
    if name == "r18":
        ...
        return VisionTransformer(
            ...
            num_heads=8, drop_path_rate=0.1, norm_layer="ln", mask_ratio=0.1, num_register_token=num_register_token)
        ...
        return VisionTransformer(
            img_size=112, patch_size=9, num_classes=num_features, embed_dim=256, depth=12,
            num_heads=8, drop_path_rate=0.05, norm_layer="ln", mask_ratio=0.0, num_register_token=num_register_token)
        ...
        return VisionTransformer(
            ...
            num_heads=8, drop_path_rate=0.1, norm_layer="ln", mask_ratio=0.1, using_checkpoint=True, num_register_token=num_register_token)
        ...
        return VisionTransformer(
            img_size=112, patch_size=9, num_classes=num_features, embed_dim=512, depth=24,
            num_heads=8, drop_path_rate=0.05, norm_layer="ln", mask_ratio=0.05, using_checkpoint=True, num_register_token=num_register_token)
        ...
        return VisionTransformer(
            ...
            num_heads=8, drop_path_rate=0.1, norm_layer="ln", mask_ratio=0, using_checkpoint=True, num_register_token=num_register_token)
